...
BUILTIN_TOOLS: list[dict] = [
    ...
    },
    {
        ...
        "description": "发送 HTTP/HTTPS 请求，支持 GET / POST / PUT / DELETE，自定义 Header 与 Body。",
        "category": "network",
        "version": "2.0.1",
        "tags": ["http", "api", "rest"],
        "params": [
            {"key": "url", "label": "URL", "required": True, "type": "string"},
            {"key": "method", "label": "方法", "required": True, "type": "string"},
            {"key": "headers", "label": "Header", "required": False, "type": "object"},
        ],
    },
    {
        "name": "web_search",
